...
public class Fader {
	...
	public Fader(final double minValue, final double maxValue) {
		// Avoid IllegalArgumentException when the new minimal-value is higher than the
	...
	public void setMinimalValue(final Double value) {
	...
	public void setMaximalValue(final Double value) {
	...
	/**
	 * Gets or sets the faders value. Automatically recalculates the percentage
	 * accordingly.
	 *
	...
	/**
	 * Gets or sets the percentage for the slider. A double value between 0.0 and
	 * 1.0.
	 *
	 ...
	 * @return what the value of the fader would be if it was at the given
	 *         percentage
	 */
	private double getValueAtPercentage(final double percentage) {
		if (inverted)
	 ...
	 * @return what the percentage of the fader would be if it was at the given
	 *         value
	 */
	private double getPercentageAtValue(final double value) {
		if (inverted) {
	 ...
	 */
	public void setQuadraticValue(final double value) {
	 ...
	 * @param value to set the fader to
	 */
	public void setCubicValue(final double value) {
	 ...
	 * @param value to set the fader to
	 */
	public void setExponentialValue(final double value) {
	 ...
	 * @param value to set the fader to
	 */
	public void setBidirectionalSlow(final double value) {
	 ...
	 * @param value to set the fader to
	 */
	public void setBidirectionalQuick(final double value) {
